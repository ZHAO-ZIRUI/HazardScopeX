...
class FactorCaseObstacleContainer(Factor):
    NAME = 'F_CaseObstacleContainer'
    ...
    def bringup(self) -> None:
        ...
        container = sa.create_static_object(
            transform=sa.transform_from_ego(front_offset=25, yaw_offset=30),

...
class FactorLotLightDarkWithParkingVehicles(Factor):
    NAME = 'F_LotLightDarkWithParkingVehicles'
    ...
    def bringup(self) -> None:
        ...
        static_list = sa.lotStatic_parking_car(distance=30,
                              mix_large=0.1, 
                              mix_emergency=0.1,
                              mix_head_in=0.3, 
                              mix_empty=0.1, 
                              limit_yaw=10.0, 
                              limit_drift_short=0.2, 
                              limit_drift_long=0.5)

...
class FactorCaseObstacleShoppingCart(Factor):
    NAME = 'F_CaseObstacleShoppingCart'
    ...
    def bringup(self) -> None:
        ...
        shopping_cart = sa.create_static_object(
            transform=sa.transform_from_ego(front_offset=15, left_offset=random.uniform(-2,2), height_offset=1, yaw_offset=15),

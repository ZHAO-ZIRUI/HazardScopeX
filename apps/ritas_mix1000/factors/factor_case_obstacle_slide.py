...
class FactorCaseObstacleSlide(Factor):
    NAME = 'F_CaseObstacleSlide'

    MAP_SPAWN_POINT_MAPPING = {
        'Carla/Maps/Town10HD_Opt': {
            'ego': 50,
            'npc': [44, 53, 56, 57, 58, 107, 109]
        },
    }
    ...
    def bringup(self) -> None:
        ...
        slide = sa.create_static_object(
            transform=sa.transform_from_ego(front_offset=20, yaw_offset=90),

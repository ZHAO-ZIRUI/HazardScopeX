...
class FactorLotCaseBehindTruckDartOut(Factor):
    NAME = 'F_LotCaseBehindTruckDartOut'
    ...
    def bringup(self) -> None:
        ...
        tf_act = self._sa.transform_from_ego(front_offset=15, left_offset=-6, yaw_offset=-90)
        act = self._sa.manual_control_vehicle(
            transform=tf_act,
            bp='vehicle.mercedes.sprinter',
            throttle=0.4,
            reverse=False
        )

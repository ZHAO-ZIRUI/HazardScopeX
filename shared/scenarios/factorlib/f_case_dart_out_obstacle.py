...
class FactorCaseDartOutObstacle(Factor):
    ...
    M_WORLD_LOCATION = {
        'Carla/Maps/Town10HD_Opt': {
            Factor.K_VEHICLE_EGO: 118,
            Factor.K_VEHICLE_ACT: 118,
            ...
            Factor.K_VEHICLE_NPC: [124, 30, 31, 33],
        },
    }
    ...
    def create_obstical(self) -> None:
        obstacle_tf: carla.Transform = self.M_WORLD_LOCATION[self._context.map_name][Factor.K_OBSTACLE]
